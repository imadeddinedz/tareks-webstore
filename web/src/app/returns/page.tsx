        ...
        <div className="min-h-screen bg-[var(--bg)] pt-12 pb-24 noise relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <h1 className="font-heading font-black text-4xl md:text-5xl text-[var(--text)] mb-4 tracking-tight">Retours & Garantie</h1>
                ...
                <div className="glass rounded-[2rem] p-8 md:p-12 border border-[var(--border)] shadow-2xl space-y-12">
                    ...
                    <section>
                        ...
                        <div className="p-6 rounded-2xl bg-[var(--surface)]/50 border border-[var(--border)] mt-6">
                            <h3 className="font-bold text-[var(--text)] mb-3">Conditions d'éligibilité au retour :</h3>
                    ...
                    <section className="text-center pt-4">
                        <h2 className="font-heading font-bold text-2xl text-[var(--text)] mb-4">Comment initier un retour ?</h2>
